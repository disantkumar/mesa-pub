...
CHIPSET(0x5926, kbl_gt3, "KBL GT3",
        "Intel(R) Iris(R) Plus Graphics 640 (Kaby Lake GT3e)")
CHIPSET(0x5927, kbl_gt3, "KBL GT3",
        "Intel(R) Iris(R) Plus Graphics 650 (Kaby Lake GT3e)")
